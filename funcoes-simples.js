...
// let idade = ler.questionInt("Qual sua idade? ")
// let cidade = ler.question("Qual sua cidade? ")
...
// console.log("-------------------------")
// }
// let usuarios = meusDados()
// exibirDados(usuarios.usuario1)
// exibirDados(usuarios.usuario2)
...
// let celsius = ler.questionFloat("Digite a temperatura ")
...
// function rodape() {
//     console.log("Sistema desenvolvido por Gustavo")
// }
...
function opcaoSomar() {
    let n1 = ler.questionFloat("Primeiro numero: ")
    let n2 = ler.questionFloat("Segundo numero: ")
